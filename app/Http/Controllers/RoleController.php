...
class RoleController extends Controller
{
    ...
    public function setPermission(Request $request)
    {
        ...
        */
        ...
        if($request->has('cron_settings')) {
            $permission = Permission::firstOrCreate(['name' => 'cron_settings']);
            if(!$role->hasPermissionTo('cron_settings')) {
                $role->givePermissionTo($permission);
            }
        }
        else {
            $permission = Permission::where('name', 'cron_settings')->first();
            if($permission)
                $role->revokePermissionTo('cron_settings');
        }
