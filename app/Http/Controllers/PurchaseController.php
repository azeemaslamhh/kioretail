...
class PurchaseController extends Controller
{
    ...
    public function create()
    {
        ...
        if($role->hasPermissionTo('purchases-add')){
            ...
            DB::enableQueryLog();
            $lims_product_list_without_variant = $this->getProduct();
            /*echo '<pre>';
    ...
    {
        return Product::ActiveStandard2()->select('id', 'name', 'code')
                ->whereNull('is_variant')->get();
    }
    public function getProduct()
    {
        return Product::ActiveStandard2()->select('id', 'name', 'code')->get();
    }
    ...
    public function limsProductSearch(Request $request)
    {
        ...
        if(!$lims_product_data) {
            $lims_product_data = Product::where([
                            ...
                            //->whereNotNull(['is_variant'])
                            ->first();
            $lims_product_data = array();                
            $lims_product_rs = Product::leftjoin('product_variants', 'products.id', 'product_variants.product_id')
                ->where([
            ...
            if($lims_product_rs->count()>0){
                $lims_product_data= $lims_product_rs->first();
