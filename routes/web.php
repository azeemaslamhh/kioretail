...
Route::group(['middleware' => ['common', 'auth', 'active']], function() {
    ...
    Route::controller(SaleController::class)->group(function () {
        Route::post('sales/sale-data', 'saleData')->name('dbSetSaleData');
        Route::post('sales/sendmail', 'sendMail')->name('sale.sendmail');
        
        Route::get('sales/view-all-sales', 'indexold')->name('viewAllSalesOld');
        Route::get('sales/getAllSales', 'getAllSales')->name('getAllSales');

        Route::get('sales/sale_by_csv', 'saleByCsv');
        Route::get('sales/product_sale/{id}', 'productSaleData');
        Route::get('sales/sale_row/{id}', 'getSaleRow');
    ...
    Route::controller(ReportController::class)->group(function () {
        Route::prefix('report')->group(function () {
            ...
            Route::post('get-courier-report', 'getCourierReport')->name('getCourierReport');
            Route::get('courier-report', 'courierReport')->name('courier.report');;
        });
    });
    ...
    Route::controller(SettingController::class)->group(function () {
        Route::prefix('setting')->group(function () {
            ...
            Route::post('run/cron/manually', 'runCronManually')->name('run.cron.manually');
            Route::any('cron', 'cronSettings')->name('setting.crons');            
         });
