              ...
              <div class="row">
                ...
                <div class="col-sm-3">
                  <div class="wrapper count-title">
                    ...
                    <div>
                        <div class="count-number return-data">{{number_format((float)$sale_return_amount,$general_setting->decimal, '.', '')}}</div>
                ...
                <div class="col-12">
                  <div id="courierRows" class="row">
                  @if(Auth::user()->role_id <= 2)    
                  @foreach($couriersArray as $couriersRow)
                  @if($couriersRow['paid_amount'] > 0 || $couriersRow['due'] > 0)
                  <div class="col-sm-3">
                    <div class="wrapper count-title">
                      <div class="icon"><i class="dripicons-trophy" style="color: #297ff9"></i></div>
                      <div>
                          <div class="count-number profit-data">{{ $couriersRow['paid_amount'] }}</div>
                          <div class="name"><strong style="color: #297ff9">{{ $couriersRow['courier_name']  }} {{trans('file.Paid')}}</strong></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-3">
                    ...
                    <div class="icon"><i class="dripicons-graph-bar" style="color: #733686"></i></div>
                      <div>
                          <div class="count-number profit-data">{{ $couriersRow['due']  }}</div>
                          <div class="name"><strong style="color: #297ff9">{{ $couriersRow['courier_name']  }} {{trans('file.Due')}}</strong></div>
                      </div>
                    </div>
                  </div> 
                  @endif
...
<script type="text/javascript">
    ...
    function dashboardFilter(data){
        ...
        var courierRows =  data[4];
        var html = '';
        for (var i = 0; i < courierRows.length; i++) {
            var courier = courierRows[i];
            console.log(courier);
            
            if(courier.paid_amount > 0 || courier.due > 0){
              html +=`<div class="col-sm-3">
                    <div class="wrapper count-title">
                      <div class="icon"><i class="dripicons-trophy" style="color: #297ff9"></i></div>
                      <div>
                          <div class="count-number">`+courier.paid_amount+`</div>
                          <div class="name"><strong style="color: #297ff9">`+courier.courier_name+` {{trans('file.Paid')}}</strong></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-3">
                    ...
                    <div class="icon"><i class="dripicons-graph-bar" style="color: #733686"></i></div>
                      <div>
                          <div class="count-number">`+courier.due+`</div>
                          <div class="name"><strong style="color: #297ff9">`+courier.courier_name+` {{trans('file.Due')}}</strong></div>
                      </div>
                    </div>
                  </div> `;
           }  
        }
        $("#courierRows").html(html);
        //console.log(data[4]);
    }
</script>
@endpush
