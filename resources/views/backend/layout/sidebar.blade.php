        <ul id="side-main-menu" class="side-menu list-unstyled">
            ...
            <ul id="report" class="collapse list-unstyled ">
                ...
                <li id="courier-report-menu">
                <a href="{{route('courier.report')}}">{{trans('file.courier_report')}}</a>
                </li>
                @endif
            ...
            <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-gear"></i><span>{{trans('file.settings')}}</span></a>
                <ul id="setting" class="collapse list-unstyled ">
                    <?php
                        ...
                        $cron_settings_permission_active = $role_has_permissions_list->where('name', 'cron_settings')->first();
                    ?>
                    @if($role->id <= 2)
                    ...
                    @endif
                    @if($cron_settings_permission_active)
                    <li id="crom-setting-menu"><a href="{{route('setting.crons')}}"> Cron Settings</a></li>
                    @endif
                </ul>
            </li>
