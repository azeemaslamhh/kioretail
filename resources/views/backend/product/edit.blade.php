                            ...
                            <div class="row">
                                                        ...
                                                        <tr>
                                                            <?php
                                                                ...
                                                                if($lims_product_data->variant_list && $variant_list[$key]) {
                                                                    ...
                                                                    $variant_list[$key] = "";
                                                            ?>
                                                            <td>{{ (isset($product->name)? $product->name:"") }} [{{ isset($product->code) ? $product->code:"" }}]</td>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                          <select name="category_id[]" multiple required class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Category...">
                                            @foreach($lims_category_list as $category)
                                                <option  value="{{$category->id}}" @if(in_array($category->id,$categoriesArray)) selected @endif  >{{$category->name}}</option>
                                            @endforeach
                                          </select>
                                      </div>
                                    </div>
