						            ...
						            <td class="report-permissions" colspan="5">
						                ...
						                <span>
						                    <div aria-checked="false" aria-disabled="false">
												...
												<div class="checkbox">
												@if(in_array("cron_settings", $all_permission))
							                    	<input type="checkbox" value="1" id="cron_settings" name="cron_settings" checked>
							                    	@else
							                    	<input type="checkbox" value="1" id="cron_settings" name="cron_settings">
							                    	@endif							                    	
							                    	
								                    <label for="cron_settings" class="padding05">{{trans('Cron Settings')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						            </td>
