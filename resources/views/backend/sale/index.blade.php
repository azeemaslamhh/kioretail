...
<script type="text/javascript">
    ...
    function saleDetails(sale){
        ...
        var htmltext = '<strong>{{trans("file.Date")}}: </strong>'+sale[0]+'<br><strong>{{trans("file.reference")}}: </strong>'+sale[1]+'<br><strong>{{trans("file.Warehouse")}}: </strong><span id="warehouseID">'+sale[27]+'</span><br><strong>{{trans("file.Sale Status")}}: </strong>'+sale[2]+'<br><strong>{{trans("file.Currency")}}: </strong>'+sale[31];
        if(sale[32])
       ...
       // console.log(sale);
        ...
        $.get( "sales/sale_row/" + sale[13],function( saleData ) {
