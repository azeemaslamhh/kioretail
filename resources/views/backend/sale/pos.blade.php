                              ...
                              <div class="table-responsive">
                                <table class="table">
                                  ...
                                  <tbody>
                                    ...
                                    $rSCustomer = DB::table('customers')->where('id',$sale->customer_id); 
                                    if($rSCustomer->count()>0){
                                        $customer   =$rSCustomer->first();
                                    }
                              ...
                              <div class="table-responsive">
                                <table class="table">
                                  ...
                                  <tbody>
                                    ...
                                    <?php  $rSCustomer = DB::table('customers')->where('id',$draft->customer_id); 
                                    if($rSCustomer->count()>0){
                                        $customer   =$rSCustomer->first();
                                    }
                                     ?>
